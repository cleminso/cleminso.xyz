...
**Layer3 <=> Web3 companies**: This relation represents the **bread and butter** for Layer3 team (B2B model). *With this [form](https://airtable.com/appgk2DnSymuD296E/shr8T3uARmvUVeshZ) and several contents provided by Layer3, I visualize the process like this:*
...
1. It's smart to **suggest a new quest** after we finished one, but why not propose 2 or 3?
As a multi pricing select, that can influence the users to select at least one. I try to explain my idea here:

{{< figure src="/img/l3-quest-sugg.png" title="" >}}
...
2. **Account Setup checklist**: when we arrive at Layer3 we can directly start our journey, and we see after we need to link a web3 address/discord/twitter.
The idea is to have a checklist to see what we have to set up to during our journey. I show that here:

{{< figure src="/img/l3-profile-set-sugg.png" title="" >}}

3. **Journey by timeline**: as we go along, more and more journeys are proposed with different timeline and in small place. The idea is to add 3 tabs where we can see quests by their respective timeline. Also add a red notification point to see when a new quest is available. See that below:

{{< figure src="/img/l3-journey-sugg.png" title="" >}}

### Product Usability

I don't pick up usability default, Layer3 has a minimalist and gamified experience and that works well!
For each action, we initiate, we know the state and what is just happened.
...
- Layer3 is oriented to try web3 product and not just boost the social engagement for web3 companies (cf: Galxe; zealy etc)
	- users can really try new products and not do boring actions as rt and create boring thread = farm
What don't I like with Layer3?
- nothing for moment
Why did I use Layer3?
